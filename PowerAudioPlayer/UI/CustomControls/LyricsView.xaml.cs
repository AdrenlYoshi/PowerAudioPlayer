        ...
        public void LoadLrc(string lrcstr)
        {
            ...
            foreach (string str in lrcstr.Split('\n'))
            {
                ...
                if (str.Length > 0 && str.IndexOf(":") != -1)
                {
                    ...
                    {
                        System.Windows.Clipboard.SetDataObject(((TextBlock)sender).Text);
                        MessageBox.Show(Player.GetString("MsgCopyed", ((TextBlock)sender).Text), Player.GetString("ProgramName"), MessageBoxButton.OK, MessageBoxImage.Information);
                    };
                    c_lrcbk.Text = lrc;
